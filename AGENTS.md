...
- `docs/audit/AUDIT_FINDINGS.md` + `docs/audit/REMEDIATION_PLAN.md` + `docs/audit/REMEDIATION_PLAN_ROUND2.md` — the 2026-08-04 code audit and fix logs. Read before making non-trivial changes.
